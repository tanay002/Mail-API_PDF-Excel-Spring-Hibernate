...
<center>
<table>
<form action="delete.do" align="center" method="post">
...
<tr><td><input type="submit" value="delete" onclick="if(!(confirm('Are you sure want to delete this Student permanently?'))) return false"><br></td></tr>

<tr><td><a href="deleteMultidata.do">Multiple Data delete</a><br></td></tr>
